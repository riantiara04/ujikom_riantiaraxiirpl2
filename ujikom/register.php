                    ...
                    <div class="card-body text-light" style="background-color: #95745d">
                        ...
                        <form action="config/aksi_register.php" method="POST">
                            ...
                            <div class="d-grid mt-2">
                                <button class="btn text-light" style="background-color: #58403b" type="submit" name="kirim">DAFTAR</button>
                            </div>
                        </form>
                        <hr>
                        <p class="text-white">Sudah punya akun? <a href="login.php" class="text-white">Masuk</a></p>
                    </div>
                </div>
            </div>
        </div>
